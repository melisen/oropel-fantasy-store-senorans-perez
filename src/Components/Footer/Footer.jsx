...
export default function Footer() {
  return (
    <Container style={{width:'100vw', position:'fixed', left:'0', bottom:'0', right:'0', display:'flex', flex:'0 0 100px', marginTop:'auto', flexDirection:'column', justifyContent:'center', alignItems:'center', backgroundColor:'#121810fa'}}>
