...
export default function Footer() {
  return (
    <Container maxWidth="xl" style={{position:'fixed', left:'0', bottom:'0', right:'0', display:'flex', flex:'0 0 50px', marginTop:'auto', flexDirection:'column', justifyContent:'center', alignItems:'center', backgroundColor:'#121810fa'}}>
